...
from .kanji_prioritizer import run_prioritizer
...
run_prioritizer_action = QAction("Run Kanji Prioritizer", mw)
...
qconnect(run_prioritizer_action.triggered, run_prioritizer)
...
mw.form.menuTools.addAction(run_prioritizer_action)
